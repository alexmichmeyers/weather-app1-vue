<template>
  <div id="app" :class="typeof weather.main != 'undefined' && weather.main.temp > 80 ? 'hot' : '' ">
    <main>
...
export default {
  ...
  data () {
    return {
      api_key:'7c14705001035e2ae57a2b470f788e8b',
...
#app.hot {
  background-image: url('./assets/hot-weather.jpeg');
}
